      ...
      <div className={AboutCSS.content}>
        ...
        <div>
          ...
          <h3 className={`${AboutCSS.last} ${AboutCSS.text}`}>
            ...
            believe that if you can see it, you can create it. I spend most of
            my time thinking and visualizing the solution to a problem before I
            start coding or implementing it.
          </h3>
